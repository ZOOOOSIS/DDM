...
import { calc2Stage } from '../calc';

const init = { EPS: '', payout: '', g1: '', g2: '', n: '', r: '', currentPrice: '' };
  ...
  return (
    <div className="card">
      ...
      <div className="form-grid">
        ...
        <Field label="g1 (1단계 성장률)" hint="예: 0.12" value={f.g1} onChange={set('g1')} />
        <Field label="g2 (영구 성장률)" hint="예: 0.03" value={f.g2} onChange={set('g2')} />
        <Field label="n (1단계 기간, 년)" hint="예: 5" value={f.n} onChange={set('n')} />
